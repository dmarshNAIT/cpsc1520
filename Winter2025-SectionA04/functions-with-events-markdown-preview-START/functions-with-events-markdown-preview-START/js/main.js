...
const textInput = document.querySelector('#markdown-input-text');
...
const renderPreview = (newContent) => { 
    document.querySelector('#markdown-preview').innerHTML = marked.parse(newContent);
};